  ...
  return (
    <Card>
      <div className="flex flex-wrap items-center gap-3">
        <HoverSubtitleTitle
          subtitle="Users can connect governed data sources, build queries, preview large result sets, and toggle visual summaries without entering the admin surface."
